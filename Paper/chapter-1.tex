...
\section{Different CAD representation models}
\begin{itemize}
	\item BREP
	\item voxel
	\item mesh (stl)
	\item point cloud
	\item back this up with literature and give pros and cons of each, i can even reference the virtual product development course
\end{itemize}
\section{Clamping methods}
\subsection{Straight Vise}

 \begin{figure}
	\centering
	\includegraphics[scale=0.4]{images/Vise.png}
	\caption{Vise}
	\label{fig:vise}
\end{figure}


\subsection{Double V block}
 \begin{figure}
	\centering
	\includegraphics[scale=0.4]{images/doubleV.jpg}
	\caption{V block double}
	\label{fig:Vblockdouble}
\end{figure}

\subsection{V block + flat}
 \begin{figure}
	\centering
	\includegraphics[scale=0.4]{images/V plus flat.jpg}
	\caption{V block + Flat}
	\label{fig:Vblockflat}
\end{figure}
\section{Conclusion}
\begin{itemize}
